...
import TxListItem from '~/components/TxListItem.vue';
...
const peggyAddress = "0x5813d1591a8efa851c952e21376f9b64b9c6e0cb";
...
<template>
  <div>
      <div class="card">
          ...
          <form class="card__content card__content--small" v-if="isConnected" @submit.prevent="submit">
              <div class="u-grid u-grid--small u-grid--vertical-margin--small">
                  ...
                  <div class="u-cell u-cell--small--auto">
                      <button class="button button--ghost-green send__submit-button" :class="{'is-loading': isFormSending, 'is-disabled': $v.$invalid}">
          ...
          <div class="card__content card__content--small send__text" v-if="isConnected">
              Wallet connected <br>
